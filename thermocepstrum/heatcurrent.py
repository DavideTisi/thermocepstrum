...
def fstar_analysis(x, TSKIP_LIST, aic_type='aic', Kmin_corrfactor=1.0, plot=True, axes=None, FIGSIZE=None,
    ...
    Parameters
    ----------
    TSKIP_LIST   = an array of sampling times [steps]
    **NOT IMPLEMENTED: FSTAR_LIST = an array of target cutoff frequencies [THz]
    Kmin_corrfactor = cepstral analysis correction factor (1.0)
    plot         = plot the PSD (True/False)
    axes
    FIGSIZE      = plot figure size
    **plot_kwargs
